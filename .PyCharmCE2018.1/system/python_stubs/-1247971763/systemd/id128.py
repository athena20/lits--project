...
SD_MESSAGE_BACKTRACE = None # (!) real value is ''

SD_MESSAGE_BOOTCHART = None # (!) real value is ''

SD_MESSAGE_CONFIG_ERROR = None # (!) real value is ''

SD_MESSAGE_COREDUMP = None # (!) real value is ''

SD_MESSAGE_DNSSEC_DOWNGRADE = None # (!) real value is ''

SD_MESSAGE_DNSSEC_FAILURE = None # (!) real value is ''

SD_MESSAGE_DNSSEC_TRUST_ANCHOR_REVOKED = None # (!) real value is ''
...
SD_MESSAGE_TRUNCATED_CORE = None # (!) real value is ''
...
SD_MESSAGE_USER_STARTUP_FINISHED = None # (!) real value is ''
